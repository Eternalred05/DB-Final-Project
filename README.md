...
# How to use
### After all necessary programs are installed, create a server called Gestion-Hospitalaria with a database, then run the .sql file included via PGAdmin 4 in the Query Tool to create all the necessary tables.
