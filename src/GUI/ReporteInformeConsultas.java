...
public class ReporteInformeConsultas extends javax.swing.JDialog {
    ...
    public ReporteInformeConsultas(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Reporte de Informes");
        configurarTabla();
        cargarHospitales();
        configurarEventos();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String codH = (h != null && h.getId() != null) ? h.getId() : null;
        String codD = (d != null && d.getId() != null) ? d.getId() : null;
        String codU = (u != null && u.getId() != null) ? u.getId() : null;

        try {
            ArrayList<TurnoLista> lista = informeDAO.informeDuranteConsultas(codH, codD, codU);
            DefaultTableModel model = (DefaultTableModel) tablaInforme.getModel();
            model.setRowCount(0);
            for (TurnoLista tl : lista) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ReporteInformeConsultas dialog = new ReporteInformeConsultas(new javax.swing.JFrame(), true);
