...
DROP FUNCTION IF EXISTS insertar_paciente(VARCHAR, INTEGER, VARCHAR, VARCHAR, DATE, BOOLEAN, VARCHAR)   CASCADE;
DROP FUNCTION IF EXISTS modificar_paciente(VARCHAR, INTEGER, VARCHAR, VARCHAR, DATE, BOOLEAN, VARCHAR)  CASCADE;
DROP FUNCTION IF EXISTS eliminar_paciente(VARCHAR, INTEGER)                                             CASCADE;
